...
CHAT_SYSTEM = (
    ...
    "overlap. Training-phase tools persist the Training schedule in Postgres and "
    "automatically append a matching note to my-goals.md — do not call append_goal_note "
    "only to record a phase change. "
