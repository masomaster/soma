...
4. The scheduled job always runs FTP estimation after upsert (90-day best MMP → prefers 60/30-min anchors, else scaled critical power / outdoor Coggan → `daily_health_metrics.ftp_*`).
